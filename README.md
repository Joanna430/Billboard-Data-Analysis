...
```{r,message = FALSE, echo = FALSE, fig.height=3.5,warning = FALSE}
setwd("E:/Rice courses/R/final project")
...
```{r,message = FALSE, echo = FALSE, fig.height=4,warning = FALSE}
...
```{r,message = FALSE, echo = FALSE,fig.height=4.7, warning = FALSE}
hot100 %>% 
    mutate(year) %>%
